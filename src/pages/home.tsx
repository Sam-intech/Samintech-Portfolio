...
export default function Home() {
  return (
    <>
      ...
      <Projects />
      <TechStack />
      <Section id="experience" className="container flex justify-between items-start p-0">
        <div className="basis-[400px] shrink-0 pl-0"><Experience /></div>
        <div className="flex-1 min-w-0 pr-0"><About /></div>
      </Section>
      <Section id="final" className="container flex flex-col justify-between items-start py-14 mb-20">
        ...
        <div className="w-full flex justify-between items-stretch gap-2">
          ...
          <div className="flex-1"><Hobbies /></div>
          <div className="flex-1"><DesignShots /></div>
        </div>
      </Section>
    </>
  )
